...
class VersionsWorkflowTests {
  ...
  @Test
  void testVersionsWorkflows() throws InterruptedException, IOException {
    ...
    assertEquals(2, activityTrackerService.getExecutedActivities().size());
