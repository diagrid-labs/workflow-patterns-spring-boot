...
class FireAndForgetWorkflowTests {
  ...
  void testAsyncTasksWorkflows() throws InterruptedException, IOException {
    ...
    await().atMost(Duration.ofSeconds(20))
        ...
        .until(() ->  {
          return (ensemble.getMicrocksContainer()
                  .getServiceInvocationsCount("API Payment Validator", "1.0.0") - callsToRemoteServiceBeforeStart) == 1;
        } );
    ...
    await().atMost(Duration.ofSeconds(5))
            .pollDelay(500, TimeUnit.MILLISECONDS)
            .pollInterval(500, TimeUnit.MILLISECONDS)
            .until(() -> notificationService.getNotifications().size() == 2);
    ...
    await().atMost(Duration.ofSeconds(10))
        ...
        .until(() -> {
          ...
          System.out.println("Payment Request processed? " + paymentRequestResultFromWorkflow.getProcessedByRemoteHttpService());
