...
class PerformanceWorkflowTests {
  ...
  @Test
  void testPerformanceActuatorTest() throws InterruptedException, IOException {
    ...
    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/start.workflow")
            .then()
            .statusCode(200);

    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/callActivity1.workflow")
            .then()
            .statusCode(200);

    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/callActivity2.workflow")
            .then()
            .statusCode(200);
    ...
    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/total.workflow")
            .then()
            .statusCode(200);

    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/activity.slow-activity")
            .then()
            .statusCode(200);
    ...
    given().contentType(ContentType.JSON)
            .when()
            .get("/actuator/metrics/activity.store-payment-request")
            .then()
            .statusCode(200);
