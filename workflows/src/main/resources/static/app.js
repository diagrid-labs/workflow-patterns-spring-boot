...
function updateOrderEntry(order) {
    console.log("adding button to order entry");
    $("#"+ order.order.id).append("<button onclick=\"approveOrder('"+ order.order.id +"')\"> <strong>Approve</strong></button>")
