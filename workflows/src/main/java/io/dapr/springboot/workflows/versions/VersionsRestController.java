...
import io.dapr.springboot.workflows.multiretry.MultiRetryWorkflow;
...
public class VersionsRestController {
  ...
  private final Logger logger = LoggerFactory.getLogger(VersionsRestController.class);
  ...
  public PaymentRequest placePaymentRequest(@RequestBody PaymentRequest paymentRequest) {
    ...
    instanceId = daprWorkflowClient.scheduleNewWorkflow(VersionsWorkflow.class, paymentRequest);
