...
@Component
public class RetryActivity implements WorkflowActivity {

  private final Logger logger = LoggerFactory.getLogger(RetryActivity.class);


  private ActivityTrackerService activityTrackerService;

  public RetryActivity(ActivityTrackerService activityTrackerService) {
