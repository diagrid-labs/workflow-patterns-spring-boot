...
@RestController
@EnableDaprWorkflows
public class CompensationHttpRestController {

  private final Logger logger = LoggerFactory.getLogger(CompensationHttpRestController.class);
   ...
   */
  @PostMapping("/compensateonerror/start")
  public PaymentRequest placePaymentRequest(@RequestBody PaymentRequest paymentRequest) {
    String instanceId = daprWorkflowClient.scheduleNewWorkflow(CompensateWhenErrorWorkflow.class, paymentRequest);
