...
/*
 ...
 This activity will only complete after sending the request to the external system.
 */
@Component
public class TaskWithSyncLogicActivity implements WorkflowActivity {

  private final Logger logger = LoggerFactory.getLogger(TaskWithSyncLogicActivity.class);
  ...
  public TaskWithSyncLogicActivity(PaymentRequestsStore ordersStore) {
