...
@RestController
@EnableDaprWorkflows
public class AsyncTasksRestController {

  private final Logger logger = LoggerFactory.getLogger(AsyncTasksRestController.class);
   ...
   */
  @PostMapping("/asynctasks/start")
  public PaymentRequest placePaymentRequest(@RequestBody PaymentRequest paymentRequest) {
    String instanceId = daprWorkflowClient.scheduleNewWorkflow(AsyncTasksWorkflow.class, paymentRequest);
